<x-app-layout>
    ...
    <body>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-14 ">
            ...
            <div class="mb-6">
                <h1 class="font-medium leading-tight text-4xl mt-0 mb-2 text-white font-black underline font-sans"> My Tickets </h1>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="th-functions">
                            <form class="" action="{{ route('delete.ticket', [$ticket->id]) }}" method="post">
                                ...
                                <button title="Delete Meeting" class="bg-red-900 p-1 delete-ticket-button rounded-md fa fa-trash-o"
                                    type="submit"></button>
                            </form>
                        </td>
                    </tr>
